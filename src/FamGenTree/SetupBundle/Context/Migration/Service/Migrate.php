...
use FamGenTree\SetupBundle\Context\Migration\Exception\MigrationException;
use FamGenTree\SetupBundle\Context\Migration\Exception\MigrationPlanStepClassNotFound;
use FamGenTree\SetupBundle\Context\Migration\Plan\MigrationPlan;
...
class Migrate implements ContainerAwareInterface
{
    ...
    /**
     * @var \FamGenTree\SetupBundle\Context\Setup\Config\ConfigDatabase
     */
    ...
    /**
     * @return \FamGenTree\SetupBundle\Context\Setup\Config\ConfigDatabase
     */
    ...
    /**
     * @param \FamGenTree\SetupBundle\Context\Setup\Config\ConfigDatabase $databaseConfig
     */
    ...
    /**
     * @return array|null
     * @throws \FamGenTree\SetupBundle\Context\Migration\Exception\MigrationException
     */
    ...
    /**
     * @return \FamGenTree\SetupBundle\Context\Migration\Plan\MigrationPlan
     */
     ...
     *
     * @return \FamGenTree\SetupBundle\Context\Migration\Plan\Step\MigrationPlanSqlStep
     * @throws \FamGenTree\SetupBundle\Context\Migration\Exception\MigrationPlanStepClassNotFound
     */
